...
function Calendar(date) {
    ...
    function getCalendar() {
        ...
        var cTable = new CalendarTable(date, weekdays);
        container.appendChild(cTable.getTable());
    ...
    function switchCalendar(next) {
        ...
        var cTable = new CalendarTable(nDate, weekdays);
        container.replaceChild(cTable.getTable(), oC);
